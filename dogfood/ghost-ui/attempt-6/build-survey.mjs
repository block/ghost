...
const OUT =
  "/Users/nahiyan/Development/ghost/dogfood/ghost-ui/attempt-6/survey.json";

const SOURCE = {
  id: "ghost-ui",
  role: "primary",
  target: "block/ghost@packages/ghost-ui",
  commit: "0406424+dirty",
  scanned_at: "2026-05-03T19:00:31Z",
  scanner_version: "dogfood-attempt-6",
};
...
const byKind = survey.values.reduce((acc, row) => {
