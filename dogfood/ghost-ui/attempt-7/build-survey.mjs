...
const OUT =
  "/Users/nahiyan/Development/ghost/dogfood/ghost-ui/attempt-7/survey.json";

const SOURCE = {
  id: "ghost-ui",
  role: "primary",
  target: "block/ghost@packages/ghost-ui",
  commit: "3e0ef1a+dirty",
  scanned_at: "2026-05-04T17:06:20Z",
  scanner_version: "dogfood-attempt-7",
};
