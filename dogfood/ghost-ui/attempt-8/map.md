...
platform: web
languages:
  - { name: typescript, files: 116, share: 0.492 }
  - { name: json, files: 113, share: 0.479 }
  - { name: javascript, files: 4, share: 0.017 }
  - { name: css, files: 2, share: 0.008 }
  - { name: markdown, files: 1, share: 0.004 }
build_system: pnpm
package_manifests:
  - package.json
composition:
