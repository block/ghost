...
const OUT =
  "/Users/nahiyan/Development/ghost/dogfood/ghost-ui/attempt-8/survey.json";

const SOURCE = {
  id: "ghost-ui",
  role: "primary",
  target: "block/ghost@packages/ghost-ui",
  commit: "a7e4af7+dirty",
  scanned_at: "2026-05-05T11:17:24Z",
  scanner_version: "dogfood-attempt-8",
};
