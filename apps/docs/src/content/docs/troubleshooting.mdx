...
- **Respect silence.** If no description indicates an applicable situation, name
  the package's silence, follow the cover silence posture, and do not claim
...
Uncommitted or unmerged ghost package edits are drafts; ghost's tooling reads
...
- **The team disagrees on what's canonical.** Ordinary Git review is the
  approval boundary for ghost package edits, same as any other code change.
