...
For visual work, it carries the same session through the full making loop:
inspect pulled materials, brief the work, make the artifact, render it, repair
visible and mechanical issues, and review the final diff when checks exist.
