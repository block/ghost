...
export function buildSkillMd(
  ...
  const fileList = [
    "- `fingerprint.md` — canonical design language (YAML digest + Character/Signature/References/Decisions/Checks)",
...
Read \`fingerprint.md\` first — it is the source of truth. It has these layered sections:
