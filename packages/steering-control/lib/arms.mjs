...
function gatherInstructions(config, askN, runK) {
  ...
  return [
    ...
    "Inspect pulled materials that govern exactness, structure, or taste. Read files, view images or rendered examples when available, and note unavailable material honestly.",
