...
function gatherInstructions(config, askN, runK) {
  ...
  return [
    ...
    "Use the pulled guidance directly. Follow its material actions before making, and note unavailable material honestly.",
    "If the pull returns a matching starting structure, start from it verbatim, then fill it with task facts.",
