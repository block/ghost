...
This fragment guides the world-model narrative for a fleet whose members each have a parent fingerprint and may also have product-surface overlays under `fingerprints/<scope>.md`.
