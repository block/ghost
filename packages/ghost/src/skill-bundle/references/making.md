...
# Recipe: Make a Visual Artifact From Ghost Fingerprint
...
2. **Select applicable nodes.** Read descriptions against the situation. Pull
   truths whose stated condition, material, structure, refusal, or decision
...
8. **Start from the Skeleton when one matches.** If the pulled packet ends with a
   ...
   Skeleton into the brief or move it ahead of the interpretive truths.
...
12. **Repair within a bounded budget.** Fix visible or mechanical problems with
    coherent changes grounded in the evidence and pulled truths. Default to two
    ...
    the pulled truths, materials, and brief, or ask for human review.
