...
alphabetically, and uncategorized guidance last. Loading failures appear in both
formats; do not treat excluded guidance as an authored absence.
...
matched material-backed nodes, offered checks, loading failures, coverage gaps,
and the diff. The host agent renders findings.
