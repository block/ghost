...
/**
 * Merge an overlay fingerprint on top of a base fingerprint. Precedence rules:
 *
 ...
 *
 * This mirrors the intent of declaring "this fingerprint is based on that one,
...
function emptyPalette(): Fingerprint["palette"] {
  return {
    dominant: [],
